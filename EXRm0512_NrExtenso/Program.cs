...
namespace EXRm0512_NrExtenso
{
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             */
            int a;
            Console.Write("Introduza um número de 0 a 9: "); // Não é feita validação, ou seja, o utilizador pode introduzir caracteres inválidos e gerar excepções(ERROS)
